            ...
            <div class="flex justify-center">
                <div class="flex items-center space-x-3 mb-8">
                    ...
                    <div class="relative select-none w-[44px]">
                        ...
                        <label  onClick={() => saludar('swicht')} class="block overflow-hidden cursor-pointer h-6 rounded-full bg-gray-400 peer-checked:bg-indigo-500" for="toggle">
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="relative col-span-full md:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
                    ...
                    <div class="px-5 pt-5 pb-6 border-b border-gray-200">
                        ...
                        <button onClick={() => saludar('hi')} class="font-medium text-sm inline-flex items-center justify-center px-3 py-2 border border-gray-200 rounded leading-5 shadow-sm transition duration-150 ease-in-out focus:outline-none focus-visible:ring-2 hover:border-gray-300 text-gray-600 w-full">Downgrade</button>
                    </div>
