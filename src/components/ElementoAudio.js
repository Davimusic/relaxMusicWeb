    ...
    return(
            <div id='contenedorAudios' style={{ width: "100%", height: '83vh', overflow: 'auto', scrollBehavior: 'smooth'}} className='scrollVertical color1 colorLetra1' >
                {arreAudiosPadre.map((item, index) => (
                    <div id={`secAudio${index}`} onClick={() => usarAudio(index, index)} key={index} style={{ width: "100%", height: '10vh', borderRadius: '0.5em', padding: '10px', display: "flex", marginBottom: '10px' }} className='efectoFondoTransparente'>
